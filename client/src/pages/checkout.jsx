...
function checkout() {
  ...
  async function handelCheckout() {
    ...
    let order = await axios.post('https://coffee-shop-api-tau.vercel.app/payment/checkout', { amount: (total * 100) });
    order = order.data;
    let key_id = await axios.get('https://coffee-shop-api-tau.vercel.app/payment/key');
    ...
    const options = {
      ...
      "callback_url": "https://coffee-shop-api-tau.vercel.app/payment/verification",
      "prefill": {
