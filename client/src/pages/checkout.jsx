...
function checkout() {
  ...
  async function handelCheckout() {
    ...
    let order = await axios.post('https://coffee-shop-5cxn.onrender.com0/payment/checkout', { amount: (total * 100) });
    order = order.data;
    let key_id = await axios.get('https://coffee-shop-5cxn.onrender.com/payment/key');
    ...
    const options = {
      ...
      "callback_url": "https://coffee-shop-5cxn.onrender.com/payment/verification",
      "prefill": {
